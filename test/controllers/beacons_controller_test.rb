...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { major: @beacon.major, minor: @beacon.minor, rssi: @beacon.rssi, uuid: @beacon.uuid }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { major: @beacon.major, minor: @beacon.minor, rssi: @beacon.rssi, uuid: @beacon.uuid }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
