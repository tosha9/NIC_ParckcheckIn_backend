...
class CheckinsControllerTest < ActionController::TestCase
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post :create, checkin: { beacon_id: @checkin.beacon_id, place_id: @checkin.place_id, temperature: @checkin.temperature, user_id: @checkin.user_id }
    end
  ...
  test "should update checkin" do
    patch :update, id: @checkin, checkin: { beacon_id: @checkin.beacon_id, place_id: @checkin.place_id, temperature: @checkin.temperature, user_id: @checkin.user_id }
    assert_redirected_to checkin_path(assigns(:checkin))
  end
